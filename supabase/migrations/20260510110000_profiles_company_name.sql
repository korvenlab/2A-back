-- Empresa do usuário quando é cliente B2B (metadata organization_name no signup).
-- Nome organization_client para não confundir com public.organizations (representações com app completo).
